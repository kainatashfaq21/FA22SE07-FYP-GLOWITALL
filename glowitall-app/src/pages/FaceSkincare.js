...
const FaceSkincare = () => {
  ...
  return (
    <>
      <Meta title={"Face Skincare"} />
      <BreadCrumb title="Skincare" />
      ...
      <Container class1="store-wrapper home-wrapper-2 py-1">
        ...
        <div className="col-12">
            <div className="mb-2">
              <img
                src="https://img.freepik.com/free-photo/beauty-portrait-sensual-ginger-woman-with-long-hair-posing-with-closed-eyes_171337-916.jpg?w=740&t=st=1688483947~exp=1688484547~hmac=a2378d01f1b0e2ab2281f7f4ad12eeba4fc36f69810c73735c84c6cf20fbd9b6"
                alt="Face"
